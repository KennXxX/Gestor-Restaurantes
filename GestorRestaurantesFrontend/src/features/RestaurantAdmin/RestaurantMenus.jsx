              ...
              <div className="mt-4 pt-3.5 border-t border-slate-100/60 flex items-center justify-between">
                <div className="flex items-center gap-4 flex-wrap">
                  ...
                  <div className="flex items-center gap-1.5 text-[11px] font-bold text-slate-500">
                    ...
                    <span>Estado</span>
                    <span className="text-emerald-700 font-extrabold">Activo</span>
                  </div>
                </div>

                {/* Edit & Menu buttons */}
                <div className="flex items-center gap-1.5">
                  <button className="rounded-xl border border-slate-200 hover:border-emerald-600 hover:bg-emerald-50 px-3.5 py-2 text-xs font-bold text-slate-700 hover:text-emerald-700 transition active:scale-[0.98] flex items-center gap-1">
                    <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5">
